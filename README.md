...
# differences
In order to stick to RaspiStillYUV working, I've modified the `MMAL_PORT_USERDATA_T` struct to hold a pointer to a memory buffer lrge enough to hold the image data.
